        ...
        <div className="flex flex-wrap mt-0 mx-[-12] justify-between px-3">
          <div className="lg:w-[42%] w-full px-3">
            <div className="relative max-w-md z-[4]">
              ...
              <p className="text-fondo_claro text-sm mb-10 leading-6 text-justify">
              ...
              <p className="mb-4">
                <Link href="/contact" className="btn bg-acento font-semibold pt-3 pr-8 pb-3 pl-8 rounded-[30px] mr-2">Cotizar ahora</Link>
        ...
        <div className="flex flex-wrap mt-[0] lg:mr-[0.75] lg:ml-[0.75px] xs:mx-3 justify-between">
          <div className="lg:w-1/2 w-full">
            ...
            <div className="my-12 flex flex-wrap mx-2 lg:mr-[0.75px] lg:ml-[0.75px]">
              <div className="w-1/2 pr-2 lg:pr-0">
                <div className="mb-8">
                  <div className="inline-block relative mb-5">
                    <Image src="/assets/truck.svg" alt="truck" width={45} height={45} className="" priority />
                  </div>
              ...
              <div className="w-1/2 pl-2 lg:pl-0">
                <div className="mb-8">
                  <div className="inline-block relative mb-5">
                    <Image src="/assets/bag.svg" alt="bag" width={45} height={45} className="" priority />
                  </div>
              ...
              <div className="w-1/2 pr-2 lg:pr-0">
                <div className="mb-8">
                  <div className="inline-block relative mb-5">
                    <Image src="/assets/support.svg" alt="support" width={45} height={45} className="" priority />
                  </div>
              ...
              <div className="w-1/2 pl-2 lg:pl-0">
                <div className="mb-8">
                  <div className="inline-block relative mb-5">
                    <Image src="/assets/return.svg" alt="return" width={45} height={45} className="" priority />
                  </div>
          ...
          <div className="lg:w-[41.67%] w-full mt-10 lg:mt-0">
            <div className="relative after:absolute after:w-[300px] lg:after:w-[500px] after:h-[200px] after:bg-whychoose after:bg-no-repeat after:bg-contain after:content-normal after:top-[-80px] after:left-[-95px] after:z-[-1]">
              <Image
                src="/images/proyectos/estructuras-metalicas.jpg"
                alt="Image"
                width={600}
                height={45}
          ...
          <div className="lg:w-[58.3%] xs:w-full lg:mb-0 mb-10 ml-3 lg:ml-0">
            <div className="grid grid-cols-weHelp relative after:absolute after:w-[255px] after:h-[217px] after:bg-weHelp after:bg-contain after:bg-no-repeat after:z-[-1] after:top-[-85px] lg:after:left-[-70px] after:left-[-110px]">
              <div className="relative col-start-1 col-end-[18] row-start-1 row-end-[27]">
                <Image src="/images/proyectos/proyecto1.png" alt="image" width={500} height={45} className="rounded-[20px] max-w-full align-middle" priority />
              </div>
              <div className="relative col-start-[19] col-end-[27] row-start-1 row-end-[5]">
                <Image src="/images/proyectos/proyecto3.png" alt="image" width={500} height={45} className="rounded-[20px] max-w-full align-middle" priority />
              </div>
              <div className="relative col-start-[14] col-end-[27] row-start-6 row-end-[27] pt-5">
                <Image src="/images/proyectos/proyecto2.png" alt="image" width={500} height={45} className="rounded-[20px] max-w-full align-middle" priority />
              </div>
            </div>
          </div>
