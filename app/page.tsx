        ...
        <div className="flex flex-wrap mt-0 mx-[-12] justify-between">
          <div className="lg:w-[42%] w-full px-3">
            <div className="relative max-w-md z-[4]">
              <h1 className="text-fondo_claro text-4xl lg:text-5xl font-bold mb-[30px] leading-10 lg:leading-[3.5rem]">
                {/* <span className="text-fondo_claro text-xl lg:text-3xl"> y proyectos</span> <br /> */}
                <span className="d-block">Diseño de equipos y proyectos</span></h1>
              <p className="text-fondo_claro text-sm mb-10 leading-6">
              ...
              <p className="mb-4">
                <Link href="/contact" className="btn bg-[#FFC300] font-semibold pt-3 pr-8 pb-3 pl-8 rounded-[30px] mr-2">Cotizar ahora</Link>
                <Link href="/shop" className="text-fondo_claro btn border-2 border-acento font-semibold pt-3 pr-8 pb-3 pl-8 rounded-[30px]">Explorar</Link>
              </p>
            </div>
          </div>
          <div className="flex relative lg:w-[58%] w-full">
            <div className="hidden lg:block xs:overflow-x-hidden after:absolute x:after:w-[255px] x:after:h-[217px] lg:after:w-[255px] lg:after:h-[217px] after:bg-bannerRight after:bg-contain after:bg-no-repeat after:right-[-60px] lg:after:right-[0px] lg:after:top-[-20px] x:after:right-[-60px] x:after:top-[-60px] xl:after:right-[0px] 2xl:after:right-[-60px]">
              <img src="images/productos/copeland-discus.png" className="x:absolute lg:relative left-0 x:max-w-[780px] xl:max-w-[680px] 2xl:max-w-[780px] lg:max-w-[650px] h-auto align-middle box-border z-[2] x:top-[-100px] lg:top-[-50px] lg:right-[-100px]" />
            </div>
            ...
            <div className="lg:hidden xs:overflow-x-hidden after:absolute xs:after:w-[220px] xs:after:h-[192px] after:bg-bannerRight after:bg-contain after:bg-no-repeat after:right-[-60px] xs:after:right-0 xs:after:top-[60px] xs:mt-20">
              <img src="images/productos/copeland-discus.png" className="relative left-0 xs:max-w-[500px] h-full align-middle box-border z-[1] xs:top-[0px] xs:right-[0px]" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="flex flex-wrap mt-0 lg:ml-[-0.75] lg:mr-[-0.75] xs:mx-3">
          ...
          <div className="w-full lg:w-1/4 mb-0">
            ...
            <p className="xs:text-center lg:text-left">
              <Link href="/shop" className="font-semibold pt-3 pr-[30px] pb-3 pl-[30px] rounded-[30px] text-white bg-primary border-primary">Explorar</Link>
            </p>
          </div>
          {/* <!-- End Column 1 --> */}
          ...
          {/* <!-- Start Column 3 --> */}
          <Item image={"images/productos/scroll-copeland.png"} name={"Cama 2 plz"} price={"00.00"} />
          {/* <!-- End Column 3 --> */}

          {/* <!-- Start Column 4 --> */}
          <Item image={"images/productos/tornillo-bitzer.png"} name={"Ropero 3 Puertas"} price={"00.00"} />
          {/* <!-- End Column 4 --> */}
        ...
        <div className="flex flex-wrap mt-[0] lg:mr-[0.75] lg:ml-[0.75px] xs:mx-3 justify-between">
            ...
            <div className="my-12 flex flex-wrap mx-2 lg:mr-[0.75px] lg:ml-[0.75px]">
              <div className="w-1/2 pr-2 lg:pr-0">
                <div className="mb-8">
                  ...
                  <p className="text-sm leading-6 text-wychoose mt-0 mb-4 mx-1">Cumplimos con los plazos. Optimizamos cada etapa del proceso para garantizar que tu 
              ...
              <div className="w-1/2 pl-2 lg:pl-0">
                <div className="mb-8">
                  ...
                  <p className="text-sm leading-6 text-wychoose mt-0 mb-4 mx-1">En Depsac, creemos que tu tiempo vale. Por eso, simplificamos el proceso de cotización 
              ...
              <div className="w-1/2 pr-2 lg:pr-0">
                <div className="mb-8">
                  ...
                  <p className="text-sm leading-6 text-wychoose mt-0 mb-4 mx-1">Nos enfocamos en ofrecer una atención cercana, profesional y resolutiva. En Depsac, 
              ...
              <div className="w-1/2 pl-2 lg:pl-0">
                <div className="mb-8">
                  ...
                  <h3 className="text-sm text-primary mt-0 mb-2 font-medium leading-[1.2]">Excelente Servicio</h3>
                  <p className="text-sm leading-6 text-wychoose mt-0 mb-4 mx-1">En Depsac, la calidad no termina en el producto. Brindamos un servicio integral que abarca desde 
          ...
          <div className="lg:w-[41.67%] w-full mt-10 lg:mt-0">
            <div className="relative after:absolute after:w-[300px] lg:after:w-[500px] after:h-[200px] after:bg-whychoose after:bg-no-repeat after:bg-contain after:content-normal after:top-[-80px] after:left-[-95px] after:z-[-1]">
              <img src="images/proyectos/estructuras-metalicas.jpg" alt="Image" className="rounded-[20px] max-w-screen-xxs lg:max-w-full h-auto align-middle ml-10 lg:ml-0" />
            </div>
          </div>
          ...
          <div className="lg:w-[58.3%] xs:w-full lg:mb-0 mb-10 ml-3 lg:ml-0">
            <div className="grid grid-cols-weHelp relative after:absolute after:w-[255px] after:h-[217px] after:bg-weHelp after:bg-contain after:bg-no-repeat after:z-[-1] after:top-[-85px] lg:after:left-[-70px] after:left-[-110px]">
              <div className="relative col-start-1 col-end-[18] row-start-1 row-end-[27]">
                <img src="images/proyectos/proyecto1.png" alt="Untree.co" className="rounded-[20px] max-w-full align-middle" />
              </div>
              <div className="relative col-start-[19] col-end-[27] row-start-1 row-end-[5]">
                <img src="images/proyectos/proyecto3.png" alt="Untree.co" className="rounded-[20px] max-w-full align-middle" />
              </div>
              <div className="relative col-start-[14] col-end-[27] row-start-6 row-end-[27] pt-5">
                <img src="images/proyectos/proyecto2.png" alt="Untree.co" className="rounded-[20px] max-w-full align-middle" />
              </div>
            </div>
          </div>
          <div className="lg:w-[41.67%] xs:w-full pl-0 lg:pl-12">
            <h2 className="text-primary mb-6 text-2xl mt-0 font-medium leading-[1.2] text-center lg:text-left">Estructuras Metalicas de Alta Calidad</h2>
