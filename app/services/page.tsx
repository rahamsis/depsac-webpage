      ...
      <div className="max-w-[1320px] w-full px-[0.75rem] mx-auto">
        <div className="flex flex-wrap mx-3 lg:mx-[-0.75rem] my-12">
          <div className="w-1/2 lgw-1/4 mb-6">
            <div className="mb-[30px]">
              <div className="inline-block relative mb-5 after:w-[33px] after:h-[33px] after:absolute after:bg-nosotros after:rounded-[50%] after:right-[-8px] after:bottom-0">
                <Image src="/assets/truck.svg" alt="truck" width={45} height={45} className="align-middle" priority />
              </div>
          ...
          <div className="w-1/2 lgw-1/4 mb-62">
            <div className="mb-[30px]">
              <div className="inline-block relative mb-5 after:w-[33px] after:h-[33px] after:absolute after:bg-nosotros after:rounded-[50%] after:right-[-8px] after:bottom-0">
                <Image src="/assets/bag.svg" alt="bag" width={45} height={45} className="align-middle" priority />
              </div>
          ...
          <div className="w-1/2 lgw-1/4 mb-62">
            <div className="mb-[30px]">
              <div className="inline-block relative mb-5 after:w-[33px] after:h-[33px] after:absolute after:bg-nosotros after:rounded-[50%] after:right-[-8px] after:bottom-0">
                <Image src="/assets/support.svg" alt="support" width={45} height={45} className="align-middle" priority />
              </div>
          ...
          <div className="w-1/2 lgw-1/4 mb-62">
            <div className="mb-[30px]">
              <div className="inline-block relative mb-5 after:w-[33px] after:h-[33px] after:absolute after:bg-nosotros after:rounded-[50%] after:right-[-8px] after:bottom-0">
                <Image src="/assets/return.svg" alt="return" width={45} height={45} className="align-middle" priority />
              </div>
